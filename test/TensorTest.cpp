...
TEST(TensorTest, reshape) {
    ...
    // copied tensor
    npp::tensor_type<double> new_tensor = npp::reshape(tensor, {left, right});
    npp::shape_type new_shape = npp::shape(new_tensor);

    ASSERT_EQ(npp::shape_type({left, right}), new_shape);
