...
TEST(TensorNetworkTest, explicitCopyConstructor) {
  ...
  ASSERT_THAT(tn.TensorShapes(), ElementsAre(npp::shape_type({2, 3, 1}),
                                             npp::shape_type({3, 1, 2})));
}
...
TEST(TensorNetworkTest, moveConstructor) {
  ...
  ASSERT_THAT(tn1.TensorShapes(), ElementsAre(npp::shape_type({2, 3, 1}),
                                              npp::shape_type({3, 1, 2})));
  ...
  ASSERT_THAT(tn2.TensorShapes(), ElementsAre(npp::shape_type({2, 3, 1}),
                                              npp::shape_type({3, 1, 2})));
