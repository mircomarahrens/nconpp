...
const char *const ERROR_OUT_OF_SIZE =
...
const char *const ERROR_PARALLEL_EDGE_PRESENT =
    "Parallel edge already present.";
const char *const ERROR_SOURCEID_NOTPRESENT =
    "Source vertex identifier not present.";
const char *const ERROR_DESTID_NOTPRESENT =
    "Destination vertex identifier not present.";
} // namespace ErrorMessages
