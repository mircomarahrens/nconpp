...
Algorithms::getConnectedComponents(const std::size_t size, const std::vector<std::vector<int>> &adjacencyList) {
...
void Algorithms::DFSVisit(int v, std::vector<bool> &visited, std::set<int> &component,
